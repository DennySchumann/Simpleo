...
const cronschedules_1 = require("../models/cronschedules");
...
class CronschedulesRouter {
     ...
     */
    getOneCronschedules(req, res) {
        const _id = req.params._id;
        cronschedules_1.default.findOne({ "_id": _id })
            .then(data => {
            res.json({
                data
            });
     ...
     */
    createCronschedules(req, res) {
        let cronschedules = null;
        try {
            cronschedules = new cronschedules_1.default(req.body);
     ...
     * @param res: return an status code or an error
     */
    updateCronschedules(req, res) {
        const _id = req.params._id;
        cronschedules_1.default.findOneAndUpdate({ _id }, req.body)
            .then((data) => {
            res.json({
                data
            });
     ...
     * @param res: return an status code or an error
     */
    deleteCronschedules(req, res) {
        const _id = req.params._id;
        cronschedules_1.default.findOneAndRemove({ _id }) //field name: value
            .then((data) => {
            res.json({
                data
            });
...
exports.default = cronschedulesRoutes.router;
