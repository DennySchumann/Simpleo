...
const eventsconnectors_1 = require("../models/eventsconnectors");
...
class EventsconnectorsRouter {
     ...
     */
    getOneEventsconnector(req, res) {
        const _id = req.params._id;
        eventsconnectors_1.default.findOne({ "_id": _id })
            .then(data => {
            res.json({
                data
            });
     ...
     */
    createEventsconnector(req, res) {
        let eventsconnector = null;
        try {
            eventsconnector = new eventsconnectors_1.default(req.body);
        }
        catch (e) {
            console.log(e);
        }
     ...
     * @param res: return an status code or an error
     */
    updateEventsconnector(req, res) {
        const _id = req.params._id;
        eventsconnectors_1.default.findOneAndUpdate({ _id }, req.body)
            .then((data) => {
            res.json({
                data
            });
     ...
     * @param res: return an status code or an error
     */
    deleteEventsconnector(req, res) {
        const _id = req.params._id;
        eventsconnectors_1.default.findOneAndRemove({ _id }) //field name: value
            .then((data) => {
            res.json({
                data
            });
...
exports.default = eventsconnectorsRoutes.router;
